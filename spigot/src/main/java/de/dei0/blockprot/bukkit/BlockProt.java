...
package de.dei0.blockprot.bukkit;

import de.dei0.blockprot.bukkit.commands.BlockProtCommand;
import de.dei0.blockprot.bukkit.config.DefaultConfig;
import de.dei0.blockprot.bukkit.integrations.*;
import de.dei0.blockprot.bukkit.listeners.*;
import de.dei0.blockprot.bukkit.metrics.IntegrationBarChart;
import de.dei0.blockprot.bukkit.nbt.StatHandler;
...
public final class BlockProt extends JavaPlugin {
    ...
    public void onLoad() {
        ...
        try { registerIntegration(new UltimateTeamsIntegration());  } catch (NoClassDefFoundError ignored) {}
