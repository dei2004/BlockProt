...
import de.dei0.blockprot.util.BlockProtUtil;
...
public final class Translator {
    ...
    public static final HashSet<String> DEFAULT_TRANSLATION_FILES = Sets.newHashSet(
        ...
        "translations_ko.yml",
        "translations_pl.yml",
        "translations_pt-br.yml",
        "translations_ru.yml",
        "translations_sk.yml",
        "translations_tr.yml",
        "translations_zh-CN.yml",
     ...
     *                      <a href="https://github.com/dei2004/BlockProt/blob/master/src/main/resources/translations_en.yml">translations_en.yml</a> for
     *                      an example.
     * @since 0.4.6
     */
